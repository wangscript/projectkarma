...
public:
	...
	void toggleContiniousFire(bool state){mvContinuousShoot=state;mvContinuousShootTimer = 0.2;};
...
protected:
	...
	bool						 mvContinuousShoot;
	double						 mvContinuousShootTimer;
	Ogre::Entity				*mvpGun1Ent,*mvpGun2Ent;
